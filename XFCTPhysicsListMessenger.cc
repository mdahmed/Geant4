...
XFCTPhysicsListMessenger::XFCTPhysicsListMessenger(XFCTPhysicsList* pPhys)
:pPhysicsList(pPhys)
{
...
XFCTPhysicsListMessenger::~XFCTPhysicsListMessenger()
{
  delete pListCmd;
  delete gammaCutCmd;
  delete electCutCmd;
...
void XFCTPhysicsListMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{ 
  if( command == pListCmd )
