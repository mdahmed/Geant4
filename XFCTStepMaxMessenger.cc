...
XFCTStepMaxMessenger::XFCTStepMaxMessenger(XFCTStepMax* stepM)
:pStepMax(stepM)
{ 
...
XFCTStepMaxMessenger::~XFCTStepMaxMessenger()
{
  delete StepMaxCmd;
}
...
void XFCTStepMaxMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{ 
